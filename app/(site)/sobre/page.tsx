    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      ...
      <section className="mt-14">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-3">
          {atores.map((a) => (
            <div key={a.titulo} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <section className="mt-14">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-3">
          {integracoes.map((i) => (
            <div key={i.titulo} className="rounded-2xl border border-slate-200 bg-mist p-6">
